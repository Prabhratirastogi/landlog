...
const NavItem: React.FC<NavItemProps> = ({ children, onclick, active }) => {
  ...
  return (
    <li className={classNames(active && router.pathname == "/" ? "bg-sky-300 shadow-inner" : "", 
  ...
  return (
    <ul className="flex px-2 pr-4 bg-gradient-to-r from-blue-100 to-sky-100 ring-1 ring-blue-200 backdrop-blur mb-0 shadow-lg select-none">
      ...
      <div className="mx-4 place-self-center place-content-center relative flex">
        <input className="pl-10 h-7 bg-blue-50 text-slate-500 placeholder:italic placeholder:font-normal placeholder:text-blue-300 focus:outline-none rounded-lg inset-2 caret-blue-400 focus:ring-1 ring-blue-200 hover:shadow-inner selection:bg-blue-300" placeholder="Search..." name="search" type="text" />
