...
export const LandItem: React.FC<LandItemProps> = ({ ...props }) => {
  return (
    <div className={classNames(props.info.active ? 'bg-sky-300 hover:bg-sky-400' : 'bg-blue-100 hover:bg-blue-200', 'w-64 flex p-4 hover:ring-1 ring-inset ring-blue-200 hover:shadow-inner')} onClick={props.onclick}>
      ...
      <div className='flex flex-col flex-grow'>
        ...
        <span className='capitalize text-xs text-slate-500'>{ props.info.location.city }, {props.info.location.state}</span>
      </div>
