...
export const LandItem = ({ name, location, count, active = false, onclick }: LandInfo) => {
  return (
    <div className={classNames(active ? 'bg-sky-300 hover:bg-sky-400' : 'bg-blue-100 hover:bg-blue-200', 'w-64 flex p-4 hover:ring-1 ring-inset ring-blue-200 hover:shadow-inner')} onClick={onclick}>
