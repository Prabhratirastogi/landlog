...
| [serve](https://github.com/TechnocultureResearch/SLAM/tree/dev/serve) | REST Server | REST API to serve the data from the NoSQL database for `CREATE`, `READ`, `UPDATE` and `DELETE` operations by the end user. Most likely a Nodejs/Express Server |
